#August 3/2022
#Understanding shich community is more diverse is not always straigtforward
...
matplot(t(ren_AB)) #Matoplot is made for matrices. Plot the columns of one matrix against the columns of another. t command is the tranpose
